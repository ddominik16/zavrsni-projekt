"""Svi Cypher upiti na jednom mjestu.

Upiti pretpostavljaju da su vec odradjeni GDS koraci iz faze 5 i 6:
  - COLLABORATED_WITH veze izmedju osoba
  - pageRank, betweennessCentrality, degreeCentrality, communityId na :Person
  - communityId na :Movie
  - SIMILAR_TO veze izmedju filmova
"""
...
# ---------------------------------------------------------------- preporuke
#
# Sedam signala, svaki normaliziran na 0-1, tezine zbrajaju 1.00.
# Rezultati se dijele u dvije razine jer bodovi nisu usporedivi:
#   razina 1 = postoji dokaz iz grafa (redatelj, >=2 glumca ili SIMILAR_TO)
#   razina 2 = samo poklapanje zanra, rangirano po kvaliteti
...
# ---------------------------------------------------------------- mreza
#
# Ego-mreza oko jedne osobe. Cijeli graf ima 166k cvorova pa se ne moze
# crtati odjednom; korisnik klikom na cvor pomice srediste.
